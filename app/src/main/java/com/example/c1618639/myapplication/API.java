...
import com.example.c1618639.myapplication.Constants;
...
public class API extends AppCompatActivity {
    ...
    private void requestPerms() {
        ActivityCompat.requestPermissions(API.this,
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length > 0
                    ...
                    Toast.makeText(API.this, getStringFromResource(R.string.perm_allow), Toast.LENGTH_SHORT).show();
                }
                return;
            }
        }
    ...
    private void shareIntent(){
        ...
        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, getStringFromResource(R.string.share_title));
